...
if(key == -1):
	plt.show()
if(key == 0):
	anim.save('orbit_polar_linear_{}_{}.mp4'.format(m1,m2), fps=30,dpi = 500, extra_args=['-vcodec', 'libx264'])
#HTML(anim.to_html5_video())
elif(key == 1):
	anim.save('orbit_polar_linear_{}_{}.gif'.format(m1,m2), writer='imagemagick', fps=30)
toc = time.time()
